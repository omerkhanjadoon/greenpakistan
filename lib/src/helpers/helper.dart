...
import 'package:green_pakistan/src/models/setting.dart';
...
//  }
  ...
  static double getTotalOrderPrice(ItemOrder itemOrder, double tax) {
    double total = itemOrder.price * itemOrder.quantity;
    itemOrder.extras.forEach((extra) {
