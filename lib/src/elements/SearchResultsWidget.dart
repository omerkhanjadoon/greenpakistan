...
import 'package:green_pakistan/src/controllers/search_controller.dart';
import 'package:green_pakistan/src/elements/CardWidget.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Search for seeds or plants',
          ...
          _con.nurserys.isEmpty
              ? CircularLoadingWidget(height: 288)
              : Expanded(
                  child: ListView.builder(
                    shrinkWrap: true,
                    primary: false,
                    itemCount: _con.nurserys.length,
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).pushNamed('/Details',
                              arguments: RouteArgument(
                                id: _con.nurserys.elementAt(index).id,
                                heroTag: widget.heroTag,
                              ));
                        },
                        child: CardWidget(
                            nursery: _con.nurserys.elementAt(index),
                            heroTag: widget.heroTag),
                      );
                    },
                  ),
