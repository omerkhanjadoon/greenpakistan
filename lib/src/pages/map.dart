...
import 'package:green_pakistan/src/controllers/map_controller.dart';
...
class _MapWidgetState extends StateMVC<MapWidget> {
  ...
  @override
  void initState() {
    _con.currentNursery = widget.routeArgument.param as Nursery;
    super.initState();
  }
        ...
        children: <Widget>[
          _con.cameraPosition == null
              ...
              : GoogleMap(
                  ...
                  onCameraIdle: () {
                    _con.getNurseryOfArea();
                  },
                  polylines: _con.polylines,
                ),
          CardsCarouselWidget(
            nurserysList: _con.topNursery,
            heroTag: 'map_nurserys',
          ),
        ],
      ),
    );
